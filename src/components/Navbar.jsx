...
const Navbar = ({ toggleSidebar, setSearchQuery,onLogout}) => {
      ...
      <>
        <header className="sticky top-0 h-[10vh] z-10 bg-white dark:bg-neutral-900 flex items-center">
            <nav className="flex items-center justify-between w-full h-full">
                ...
                <div className="max-sm:hidden rounded-md p-4  ml-3 bg-white shadow-md flex justify-between items-center">
